...
#define configMINIMAL_STACK_SIZE		( ( unsigned short ) 130 )	//空闲任务的最小堆栈大小
#define configTOTAL_HEAP_SIZE			( ( size_t ) ( 16 * 1024 ) )	//FreeRTOS 动态内存池的总大小
...
function. */
#define configLIBRARY_LOWEST_INTERRUPT_PRIORITY			0xf		//定义最低中断优先级（数值越大，优先级越低）
